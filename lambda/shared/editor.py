...
def draft(tenant_id):
    ...
    for r in _rows(tenant_id, """
        ...
        sections.append({
            ...
            # Sent to the screen so it can be edited. It was selected and
            # ordered by, and then dropped - so the editor could not read the
            # order it was displaying, let alone change it.
            "sort_order": _col(r, 6),
